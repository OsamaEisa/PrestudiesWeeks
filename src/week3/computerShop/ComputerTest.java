...
public class ComputerTest {
  ...
  public static void main(String[] args) {
    ...
    // calling the method we created to get all Computers
    ArrayList<Computer> computers = getComputers(); // check the code below the main method
    ...
    // calling the calculateProfit method to get the total profit
    System.out.printf("The potential profit if all computers are sold would be: %.2f EUR", computerShop.calculateProfit());

  }

  // a method to create the computers and return array list of computers objects
